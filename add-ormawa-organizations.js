...
const organizations = [
  { name: 'BPH' },
  { name: 'Devisi Bidang Kepedulian dan Kesejahteraan sosial' },
  { name: 'Devisi Bidang Keilmuan' },
  { name: 'Devisi Bidang Unit Kreatifitas Mahasiswa' }
]
...
async function seedOrganizations() {
  ...
  console.log('Seeder organisasi ORMAWA selesai.')
  console.log(JSON.stringify(results, null, 2))
}

seedOrganizations().catch((error) => {
  console.error('Gagal menjalankan seeder organisasi ORMAWA:', error)
  process.exit(1)
})
